...
vi.mock("./components/MobileViewportBackdrop.js", () => ({
  MobileViewportBackdrop: () => null,
}));

vi.mock("./components/SafariTintProbe.js", () => ({
  SafariTintProbe: () => null,
}));
...
describe("App", () => {
  ...
  describe("authenticated layout", () => {
    ...
    it("renders Sidebar, TopBar, and HomePage when on home route with no session", () => {
      ...
      // full chrome and the home page content.
      render(<App />);
