  ...
  return (
    <div className="min-h-screen bg-background text-foreground font-sans">
      ...
      <div className="max-w-5xl mx-auto px-6 py-8 space-y-12">
        ...
        <Section title="Tool Progress" description="Real-time progress indicator shown while tools are running">
          <div className="space-y-4 max-w-3xl">
            <Card label="Single tool running">
              <div className="flex items-center gap-1.5 text-xs text-muted-foreground font-mono pl-9">
          ...
          <div className="w-[280px] border border-border rounded-xl overflow-hidden bg-card">
            ...
            <div className="px-4 py-3 border-b border-border space-y-2.5">
              <div className="flex items-center justify-between">
                ...
                <span className="text-sm font-medium text-foreground tabular-nums">$0.1847</span>
              </div>
              <div className="space-y-1">
                <div className="flex items-center justify-between">
                  <span className="text-xs text-muted-foreground uppercase tracking-wider">Context</span>
                  <span className="text-xs text-muted-foreground tabular-nums">62%</span>
                </div>
              ...
              <div className="flex items-center justify-between">
                <span className="text-xs text-muted-foreground uppercase tracking-wider">Turns</span>
                <span className="text-sm font-medium text-foreground tabular-nums">14</span>
              </div>
            </div>
            {/* Task header */}
            <div className="px-4 py-2.5 border-b border-border flex items-center justify-between">
              <span className="text-xs font-semibold text-foreground">Tasks</span>
              <span className="text-xs text-muted-foreground tabular-nums">2/{MOCK_TASKS.length}</span>
            </div>
            {/* Task list */}
            ...
            <Card label="Config mode with mixed enabled/disabled sections">
              <div className="w-[320px] border border-border rounded-xl overflow-hidden bg-card">
                ...
                <div className="shrink-0 border-t border-border px-3 py-2.5 flex items-center justify-between">
                  <Button type="button" variant="ghost" size="xs" className="h-auto px-0 py-0 text-xs text-muted-foreground">Reset to defaults</Button>
                  <Button type="button" variant="ghost" size="xs" className="h-auto px-0 py-0 text-xs text-primary hover:text-primary">Done</Button>
                </div>
              </div>
            </Card>
          </div>
          ...
          <div className="space-y-3 max-w-3xl">
            ...
            <Card label="Connected">
              <div className="flex items-center gap-2 px-3 py-2 bg-card border border-border rounded-lg">
                ...
                <span className="text-xs text-muted-foreground ml-auto">claude-opus-4-6</span>
              </div>
            </Card>
              ...
              <div className="border-t border-border bg-card px-4 py-3">
                <div className="relative bg-card/95 border border-border rounded-[14px] shadow-[0_10px_30px_rgba(0,0,0,0.10)] overflow-visible">
                  <div className="flex items-end gap-2 px-2.5 py-2">
                    <div className="mb-0.5 flex items-center gap-1.5 px-2.5 py-1.5 rounded-md border border-border text-xs font-semibold text-muted-foreground">
                ...
                <div className="relative bg-card/95 border border-border rounded-[14px] shadow-[0_10px_30px_rgba(0,0,0,0.10)] overflow-visible">
                  <div className="absolute left-2 right-2 bottom-full mb-1 max-h-[180px] overflow-y-auto bg-card border border-border rounded-[10px] shadow-lg z-20 py-1">
                    <div className="px-3 py-2 flex items-center gap-2.5 bg-accent">
                      ...
                      <div className="flex-1 min-w-0">
                        <div className="text-sm font-medium text-foreground truncate">@review-pr</div>
                        <div className="text-xs text-muted-foreground truncate">Review this PR and list risks, regressions, and missing tests.</div>
                      </div>
            ...
            <Card label="Plan mode active">
              <div className="border-t border-border bg-card px-4 py-3">
                <div className="relative bg-card/95 border border-primary/40 rounded-[14px] shadow-[0_10px_30px_rgba(0,0,0,0.10)] overflow-visible">
                  <div className="flex items-end gap-2 px-2.5 py-2">
                    <div className="mb-0.5 flex items-center gap-1.5 px-2.5 py-1.5 rounded-md border border-primary/40 text-xs font-semibold text-primary bg-primary/8">
                      <svg viewBox="0 0 16 16" fill="currentColor" className="w-3.5 h-3.5">
        ...
        {/* ─── Streaming Indicator ──────────────────────────────── */}
        <Section title="Streaming Indicator" description="Ember-glow cursor and cascading-dot generation pill shown during streaming">
          <div className="space-y-4 max-w-3xl">
            <Card label="Streaming with ember cursor">
            ...
            <Card label="Generation stats pill">
              <div className="flex items-center">
                <div className="gen-bar text-sm font-sans">
                  ...
                  <span className="text-muted-foreground/60">12s</span>
                  <span className="text-muted-foreground/30">&middot;</span>
                  <span className="text-muted-foreground/60">&darr; 1.2k</span>
                </div>
              </div>
            </Card>
            <Card label="Tool progress with cascade dots">
              <div className="flex items-center gap-1.5 text-xs text-muted-foreground font-mono pl-9">
                <span className="gen-dots-group">
                  <span className="gen-dot" />
                  <span className="gen-dot" />
                ...
                <span>Terminal</span>
                <span className="text-muted-foreground/60">7s</span>
                <span className="text-muted-foreground/40">&middot;</span>
                <span>Read File</span>
                <span className="text-muted-foreground/60">2s</span>
              </div>
    ...
    <div className="rounded-lg border border-border bg-background">
      <div className="flex items-center gap-2 px-2.5 py-2">
        ...
        <Button type="button" variant="ghost" onClick={() => setExpanded(!expanded)} className="min-w-0 flex-1 h-auto justify-start px-0 py-0 text-left">
          <span className="text-xs font-medium text-foreground truncate block">{server.name}</span>
        </Button>
      ...
      {expanded && (
        <div className="px-2.5 pb-2.5 space-y-1.5 border-t border-border pt-2">
          ...
          {server.error && (
            <div className="text-xs text-destructive bg-destructive/5 rounded px-2 py-1">{server.error}</div>
          )}
  ...
  return (
    <div className={`px-2.5 py-2 rounded-lg ${isCompleted ? "opacity-50" : ""}`}>
      <div className="flex items-start gap-2">
        ...
        <span className={`text-sm leading-snug flex-1 ${isCompleted ? "text-muted-foreground line-through" : "text-foreground"}`}>
          {task.subject}
        </span>
      </div>
      {isInProgress && task.activeForm && (
        <p className="mt-1 ml-6 text-xs text-muted-foreground italic truncate">{task.activeForm}</p>
      )}
