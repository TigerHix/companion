      ...
      >
        <MenuPrimitive.Popup
          ...
          className={cn(
            ...
            "ring-foreground/10 bg-popover text-popover-foreground min-w-32 rounded-md p-1 shadow-md ring-1 duration-100",
            "z-[100] max-h-(--available-height) w-(--anchor-width) origin-(--transform-origin)",
  ...
  return (
    <MenuPrimitive.SubmenuTrigger
      ...
      className={cn(
        ...
        "not-data-[variant=destructive]:focus:**:text-accent-foreground",
        "gap-2 rounded-sm px-2 py-1.5 text-sm [&_svg:not([class*='size-'])]:size-4",
        "flex cursor-default items-center outline-hidden select-none data-[inset]:pl-8",
        "[&_svg]:pointer-events-none [&_svg]:shrink-0",
        className
      )}
      {...props}
  ...
  return (
    <DropdownMenuContent
      ...
      className={cn(
        ...
        "data-[side=bottom]:slide-in-from-top-2 data-[side=left]:slide-in-from-right-2",
        "data-[side=right]:slide-in-from-left-2 data-[side=top]:slide-in-from-bottom-2",
        "ring-foreground/10 bg-popover text-popover-foreground min-w-[96px] rounded-md p-1 shadow-lg ring-1 duration-100 w-auto",
        className
      )}
      align={align}
      alignOffset={alignOffset}
  ...
  return (
    <MenuPrimitive.CheckboxItem
      ...
      className={cn(
        ...
        "gap-2 rounded-sm py-1.5 pr-8 pl-2 text-sm [&_svg:not([class*='size-'])]:size-4",
